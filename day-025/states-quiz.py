...
# turtle.mainloop() #alternative way of keeping the screen open even though our code has finished running. Also an alternative to screen.exitonclick()
...
while len(guessed_states) < 50:
    ...
    if answer_state in all_states:
        ...
        t.write(answer_state) # can also write t.write(state_data.state.item())